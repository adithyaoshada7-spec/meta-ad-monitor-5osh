...
export const CampaignTable: React.FC<CampaignTableProps> = ({
  ...
  return (
    <div className="bg-slate-900/80 border border-slate-800 rounded-2xl shadow-xl backdrop-blur-md overflow-hidden">
      ...
      {/* Controls Bar: Search & Objective Filters */}
      <div className="p-4 lg:p-5 border-b border-slate-800 flex flex-col lg:flex-row items-center justify-between gap-4">
            ...
            {campaigns.length === 0 ? (
              <tr>
                <td colSpan={9} className="py-12 text-center text-slate-500">
                  <div className="flex flex-col items-center justify-center gap-2">
                    ...
                    <p className="text-xs text-slate-500">Try changing your search term or objective filter.</p>
                  </div>
                </td>
              </tr>
            ) : (
              campaigns.map((cmp) => {
                ...
                return (
                  ...
                  >
                    {/* Campaign Name */}
                    <td className="py-3.5 px-4 lg:px-6 max-w-[260px]">
